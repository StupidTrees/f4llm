...
1. The add_communicators method of the gRPCCommunicationManager class
2. The get_communicators method of the gRPCCommunicationManager class
3. The send and receive method of the gRPCCommunicationManager class
"""
...
class TestgRPCCommunicationManager(unittest.TestCase):
    ...
    def test_add_communicators(self):
        init_comm_managers()
        TestgRPCCommunicationManager.client1_comm_manager.add_communicators(
        ...
        TestgRPCCommunicationManager.client2_comm_manager.add_communicators(
            'server', '127.0.0.1:50051'
        )
        self.assertEqual(
            TestgRPCCommunicationManager.client2_comm_manager.communicators,
        ...
        TestgRPCCommunicationManager.server_comm_manager.add_communicators(
    ...
    def test_get_communicators(self):
        ...
        self.assertEqual(
            TestgRPCCommunicationManager.server_comm_manager.get_communicators(['client1', 'client2']),
        {
                'client1': '127.0.0.1:50052',
                'client2': '127.0.0.1:50053'
            }
