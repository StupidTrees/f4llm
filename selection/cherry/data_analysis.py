...
def main(args: DataAnalysisArguments):
    ...
    if args.quant < 32:
        bnb_config = BitsAndBytesConfig(
            load_in_8bit=args.quant == 8,  # load the model into memory using 8-bit precision
            load_in_4bit=args.quant == 4,  # load the model into memory using 4-bit precision
...
if __name__ == "__main__":
    args = HfArgumentParser(DataAnalysisArguments).parse_args_into_dataclasses()[0]
    main(args)
