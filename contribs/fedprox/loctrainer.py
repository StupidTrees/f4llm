...
class FedProxLocSFTTrainer(LocalSFTTrainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        return_values = super(FedProxLocSFTTrainer, self).compute_loss(model, inputs, return_outputs=return_outputs)
...
class FedProxLocDPOTrainer(LocalDPOTrainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        return_values = super(FedProxLocDPOTrainer, self).compute_loss(model, inputs, return_outputs=return_outputs)
